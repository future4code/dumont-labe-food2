...
import { LoginContainer, Logo, Button } from '../LoginPage/styled';
...
import { cpfMask } from '../../../constants/fixed'
...
const SignUpPage = () => {
  ...
  const checkIfPasswordsMatch = (event) => {
    ...
    errorState ? window.alert('As senhas devem ser iguais.') : onSubmitForm()  
  }
